...
export const Home = (props) => {
  return (
    <div className='home-container'>
    {
      ...
      <img className='home-img' alt='dog infront of mountains' src={require("../../assets/images/mountains.jpg")} />
      {
        props.isAbout && <div className='home-card'>
          <NavLink to='/' className='home-btn'><img className='close-img' alt='close button' src={require("../../assets/images/cross-mark.png")} /></NavLink> 
